...
export const ServerMember = ({ member, server }: ServerMemberProps) => {
  ...
  return (
    ...
    >
      ...
      <p
        className={cn(
          "font-semibold text-sm tect-zinc-500 group-hover:tect-zinc-600 dark:text-zinc-400 dark:group-hover:text-zin-300 transition",
          params?.memberId === member.id &&
            "text-primary dark:tect-zinc-200 dark:group-hover:text-white"
        )}
      >
        {member.profile.name}
      </p>
